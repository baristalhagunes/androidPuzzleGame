...
public class Main14Activity extends AppCompatActivity {
    ...
    int skor=100;
    String kelime = "AKTİF";
    String kelime1 = "AKİKA";
    String kelime2 = "FİTKA";
    String kelime3 = "TİFKA";
        ...
        tmmp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edt.getText().toString().equals(kelime)) {
                    ...
                    btnn9.setText(btnn5.getText());
                    btnn8.setText(btnn6.getText());
                    btnn4.setText(btnn24.getText());
                    btnn18.setText(btnn19.getText());
                    btnn22.setText(btnn7.getText());
