...
public class Main18Activity extends AppCompatActivity {
    ...
    int skor=100;
    String kelime = "AZİZE";
    String kelime1 = "EZİZA";
    String kelime2 = "AZEZİ";
    String kelime3 = "AZEZE";
        ...
        tmmp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edt.getText().toString().equals(kelime)) {
                    ...
                    btnn16.setText(btnn24.getText());
                    btnn20.setText(btnn5.getText());
                } else if (edt.getText().toString().equals(kelime1)) {
                    btnn10.setText(btnn5.getText());
                    btnn11.setText(btnn24.getText());
                    ...
                    btnn8.setText(btnn24.getText());
                    btnn4.setText(btnn5.getText());
                    btnn18.setText(btnn19.getText());
                    btnn22.setText(btnn6.getText());
                } else if(edt.getText().toString().equals(kelime3)){
                    btnn12.setText(btnn7.getText());
                    btnn13.setText(btnn19.getText());
                    btnn14.setText(btnn5.getText());
                    btnn15.setText(btnn19.getText());
                    btnn23.setText(btnn5.getText());
